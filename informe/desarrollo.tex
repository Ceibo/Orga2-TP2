...
%EXPLICAR PROCESAMIENTO DE COLUMNAS CON SIMD
%EXPLICAR QUE PONE LA MATRIZ P EN 0

\par Esto lo vamos a procesar con instrucciones SIMD.
Como estamos recorriendo solo las celdas "interiores" de las matrices con las que trabajamos, empezamos situandonos en la posición (1,1). Luego hacemos uso de las instrucciones SIMD para ir procesando 4 celdas en cada ciclo.\newline
...
\par Con eso termina el primer ciclo de esta función. Ahora llamamos dos vees a solver\_set\_bnd para completar los bordes de la matriz, que no los había tocado anteriormente.
La llamamos una vez con la matriz "div" y otra con la matriz "p".
Luego, llamamos a solver\_lin\_solve para calcular la disusión del fluido.\newline
